...
public class MuskRat : Monster
{
    ...
    private void Awake()
    {
        ...
        attackBox[0] = new Vector3(-4, 0, 4);
        attackBox[1] = new Vector3(4, 0, 4);
        attackBox[2] = new Vector3(-4, 0, -4);
        attackBox[3] = new Vector3(4, 0, -4);
        attackBox[4] = new Vector3(-4, 0, 0);
        attackBox[5] = new Vector3(4, 0, 0);
        attackBox[6] = new Vector3(0, 0, -4);
        attackBox[7] = new Vector3(0, 0, 4);
